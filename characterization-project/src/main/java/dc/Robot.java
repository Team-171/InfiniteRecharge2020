...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV_LEFT = 1024 / 4.;
  static private double ENCODER_EDGES_PER_REV_RIGHT = 1024 / 16.;
  ...
  public void robotInit() {
    ...
    Talon leftMotor1 = new Talon(0);
    leftMotor1.setInverted(true);

    Talon rightMotor1 = new Talon(2);
    ...
    double encoderConstantLeft = (1 / ENCODER_EDGES_PER_REV_LEFT) * WHEEL_DIAMETER * Math.PI;
    double encoderConstantRight = (1 / ENCODER_EDGES_PER_REV_RIGHT) * WHEEL_DIAMETER * Math.PI;

    Encoder leftEncoder = new Encoder(0, 1);
    leftEncoder.setDistancePerPulse(encoderConstantLeft);
    leftEncoderPosition = leftEncoder::getDistance;
    leftEncoderRate = leftEncoder::getRate;

    Encoder rightEncoder = new Encoder(2, 3);
    rightEncoder.setDistancePerPulse(encoderConstantRight);
